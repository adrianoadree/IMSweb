...
const LoginPage = () => {
    const { googleSignIn, user, } = UserAuth(); // google authentication
    const navigate = useNavigate(); // navigation module
    
    const signInButtonRef = useRef(null) // reference to sign in button node
    const [isScrolling, setIsScrolling] = useState() // listener of user scrolling
    const [width, setWidth] = useState(window.innerWidth); // window with
    const isMobile = width <= 768; // mobile screen width criteria
    
    const warehouseMappingImages = [
        "https://firebasestorage.googleapis.com/v0/b/inventoryapp-330808.appspot.com/o/system%2Flogin_page%2Fwarehouse_mapping_map.png?alt=media&token=62802399-6c0a-4d43-b37f-a7c87b557c45", 
        "https://firebasestorage.googleapis.com/v0/b/inventoryapp-330808.appspot.com/o/system%2Flogin_page%2Fwarehouse_mapping_choices.png?alt=media&token=4f8475f0-c6cc-4c51-9d4c-82d134e9a0a5", 
        "https://firebasestorage.googleapis.com/v0/b/inventoryapp-330808.appspot.com/o/system%2Flogin_page%2Fwarehouse_mapping_storage.png?alt=media&token=4fdbd0b1-d9e6-4c6f-8c5d-2cfee786d748"
    ]
    ...
    // add animation to sign in button on user scroll
    useEffect(() => {
        if (isScrolling) {

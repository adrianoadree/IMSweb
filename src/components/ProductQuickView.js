...
import { Cube, Grid, Pricetag, Cart, GitBranch, Close } from 'react-ionicons'
import { Spinner } from 'loading-animations-react';

function ProductQuickView(props) {
  const [docId, setDocId] = useState(); // product id
  const [stockcardDocId, setStockcardDocId] = useState(""); // product id 
  const [stockcardDoc, setStockcardDoc] = useState(); // stockcard data
